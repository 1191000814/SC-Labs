 ...
 * Turtle interface.
 * 
 * Defines the interface that any Lab_1.turtle must implement. Note that the
 * standard directions/rotations use Logo semantics: initial heading
 * of zero is 'up', and positive angles rotate the Lab_1.turtle clockwise.
 * 
...
public interface Turtle {
    ...
    /**
     * Move the Lab_1.turtle forward a number of steps.
     * 
    ...
    /**
     * Change the Lab_1.turtle's heading by a number of degrees clockwise.
     * 
    ...
    /**
     * Change the Lab_1.turtle's current pen color.
     * 
    ...
    /**
     * Draw the image created by this Lab_1.turtle.
     */
    public void draw();
